        ...
        <table className="table shadow">
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>
                <Link href="/dashboard/room_student_detailes">Algebra</Link>
              </td>
              <td>20-3-2020</td>
              <td>علوم</td>
            ...
            <tr>
              <th scope="row">2</th>
              <td>
                <Link href="/dashboard/student_profile">geometry</Link>
              </td>
              <td>20-3-2020</td>
              <td>علوم</td>
            ...
            <tr>
              <th scope="row">3</th>
              <td>
                <Link href="/dashboard/student_profile">cs</Link>
              </td>
              <td>20-3-2020</td>
              <td>علوم</td>
        ...
        <table className="table shadow">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Link
                  href="/dashboard/room_student_detailes"
